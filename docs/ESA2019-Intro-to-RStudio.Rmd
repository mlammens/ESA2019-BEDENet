...
Let's make a new R Project associated with your ESA-2019-DataSci directory. 
...
Use the graphical user interface (GUI) to navigate to the ESA-2019-DataSci directory, then select "Create Project".
