...
She measured pH, Nitrate, and Phosphorus at five different sites on the Pace campus (each with different vegetation types). 
The data are below.
...
* Did students evaluate their peers work in a way that conveys understanding of different ways to visualize data? (Use [peer-eval.docx](https://mlammens.github.io/ESA2019-BEDENet/docs/peer-eval.docx) tool.)
